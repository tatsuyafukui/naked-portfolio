      ...
      <main className={styles.main}>
        ...
        <div>
          <Container className={styles.container}>
            <div>
              <Overlay className={styles.visual} overlayStyle={{backgroundColor: "rgba(3, 0, 39, 0.39)"}}>
                <Front>
                ...
                <Back>
                  <Img
                    fluid={skill.scene.image.childImageSharp.fluid}
                  />
                </Back>
              </Overlay>
            </div>
                ...
                <div>
                  ...
                  <List>
                    {skill.standard.basic.map(item => (
                      <ListItem><Txt>{item}</Txt></ListItem>
                    ))}
                  </List>
                </div>
                <div>
                  ...
                  <List>
                    {skill.standard.practical.map(item => (
                      <ListItem key={item}><Txt>{item}</Txt></ListItem>
                    ))}
                  </List>
                </div>
              </div>
