...
storiesOf(`Atoms/Txt`, module)
  ...
  .add(`テキスト - XS`, () => <Txt fontSize={FontSize.xs}>テキストを表示</Txt>)
  .add(`テキスト - S`, () => <Txt fontSize={FontSize.s}>テキストを表示</Txt>)
  .add(`テキスト - M`, () => <Txt>テキストを表示</Txt>)
  .add(`テキスト - L`, () => <Txt fontSize={FontSize.l}>テキストを表示</Txt>)
  .add(`テキスト - XL`, () => <Txt fontSize={FontSize.xl}>テキストを表示</Txt>)
  .add(`テキスト - XXL`, () => (
  ...
  .add(`危険テキスト - M`, () => <DangerTxt>危険テキストを表示</DangerTxt>)
  .add(`危険テキスト - L`, () => (
  ...
  .add(`優先テキスト - M`, () => <PrimaryTxt>優先テキストを表示</PrimaryTxt>)
  .add(`優先テキスト - L`, () => (
