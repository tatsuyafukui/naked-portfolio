...
const HolyGrailLayoutContainer = ({
  presenter,
  children,
  ...props
}) => {
...
export const HolyGrailTop = () => (
  <div>これはレンダリングされない</div>
);
export const HolyGrailRight = () => (
  <div>これはレンダリングされない</div>
);
export const HolyGrailMain = () => (
  <div>これはレンダリングされない</div>
);
export const HolyGrailBottom = () => (
  <div>これはレンダリングされない</div>
);
export const HolyGrailLeft = () => (
  <div>これはレンダリングされない</div>
);
