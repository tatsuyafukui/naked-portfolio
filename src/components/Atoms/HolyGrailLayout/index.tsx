...
const HolyGrailLayoutPresenter: React.FC<IProps> = ({tag: Tag='div', parts, className, ...props}) => {
...
const HolyGrailLayoutContainer: React.FC<IPropsContainer> = ({presenter, children, ...props}) => {
...
export const HolyGrailTop: React.FC = ({children}) => <div>これはレンダリングされない</div>;
export const HolyGrailRight: React.FC = ({children}) => <div>これはレンダリングされない</div>;
export const HolyGrailMain: React.FC = ({children}) => <div>これはレンダリングされない</div>;
export const HolyGrailBottom: React.FC = ({children}) => <div>これはレンダリングされない</div>;
export const HolyGrailLeft: React.FC = ({children}) => <div>これはレンダリングされない</div>;
